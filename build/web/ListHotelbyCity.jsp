                        ...
                        <div id="header">
                            ...
                            <div id="body">
                                <div class="page-div" style="margin-right: -180px;">
                                    ...
                                    <form class="sort" action="hotel" method="get">
                                        ...
                                        <input style="text-align: center; font-family: cursive; font-style: italic" class="submit" type="text" name="showlist" value="${selectedCity}" readonly>
                                        </div>
                                    </form>
                                </div>
