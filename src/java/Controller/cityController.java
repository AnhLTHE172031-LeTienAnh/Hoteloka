 ...
 * @author ASUS
 */
@WebServlet(name="cityController", urlPatterns={"/city"})
public class cityController extends HttpServlet {
    ...
    throws ServletException, IOException {
        City ci = new City();
        //lay danh sach city tu db
        ArrayList<City> data1 = ci.getListCity();
        //truyen danh sach city vao data1
        request.setAttribute("data1", data1);
        //chuyen huong den ListAddress.jsp
